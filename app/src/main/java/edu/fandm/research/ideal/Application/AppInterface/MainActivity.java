...
import edu.fandm.research.ideal.Application.Database.AppSummary;
import edu.fandm.research.ideal.Application.Database.DatabaseHandler;
import edu.fandm.research.ideal.Application.Helpers.ActivityRequestCodes;
import edu.fandm.research.ideal.Application.Helpers.PreferenceHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread predicting = new Thread() {
            @Override
            public void run() {
                while (!isInterrupted()) {
                    try {
                        Thread.sleep(60000);  /// Phyo: 60000 ms = 1 minute
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                PredictionActivity.activityPrediction(timestamp, getApplicationContext(), apps);
                            }
                        });
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.predict:
                Intent i3 = new Intent(this, PredictionActivity.class);
                startActivity(i3);
                return true;
        ...
        if (adapter == null) {
            ...
            listLeak.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    intent.putExtra(IDEAL.EXTRA_PACKAGE_NAME, app.getPackageName());
                    intent.putExtra(IDEAL.EXTRA_APP_NAME, app.getAppName());
                    intent.putExtra(IDEAL.EXTRA_IGNORE, app.getIgnore());
