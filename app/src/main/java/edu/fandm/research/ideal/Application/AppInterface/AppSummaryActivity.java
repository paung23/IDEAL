...
import edu.fandm.research.ideal.Application.Database.CategorySummary;
...
public class AppSummaryActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        packageName= intent.getStringExtra(IDEAL.EXTRA_PACKAGE_NAME);
        appName = intent.getStringExtra(IDEAL.EXTRA_APP_NAME);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra(IDEAL.EXTRA_ID, category.notifyId);
                intent.putExtra(IDEAL.EXTRA_PACKAGE_NAME, packageName);
                intent.putExtra(IDEAL.EXTRA_APP_NAME, appName);
                intent.putExtra(IDEAL.EXTRA_CATEGORY, category.category);
                intent.putExtra(IDEAL.EXTRA_IGNORE, category.ignore);
