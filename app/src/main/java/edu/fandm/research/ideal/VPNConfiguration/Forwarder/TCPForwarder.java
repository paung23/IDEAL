...
import edu.fandm.research.ideal.VPNConfiguration.Protocol.IP.IPDatagram;
import edu.fandm.research.ideal.VPNConfiguration.Protocol.IP.IPPayLoad;
import edu.fandm.research.ideal.VPNConfiguration.Protocol.TCP.TCPDatagram;
import edu.fandm.research.ideal.VPNConfiguration.Protocol.TCP.TCPHeader;
import edu.fandm.research.ideal.VPNConfiguration.Protocol.TCPConnectionInfo;
...
//TODO: find out why this would happen
    ...
    private void send(byte[] request) {
        ...
        try {
            ...
            IDEAL.tcpForwarderWorkerWrite += request.length;
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
